package com.mobilecloud.video.json;
 ...
 * You can comment out the Application.halObjectMapper() and return the application if you would
...
public class ResourcesMapper extends ObjectMapper {
	...
	private JsonSerializer<CollectionModel> serializer = new JsonSerializer<CollectionModel>() {

		// We are going to register this class to handle all instances of type
		// Resources
		@Override
		public Class<CollectionModel> handledType() {
			return CollectionModel.class;
		}

		@Override
		public void serialize(CollectionModel value, JsonGenerator jgen, SerializerProvider provider) throws IOException,JsonProcessingException {
